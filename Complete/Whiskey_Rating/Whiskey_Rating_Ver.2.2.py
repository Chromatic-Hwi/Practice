...
class ScoreApp:
    def __init__(self, root):
        ...
        # Draw lines for Nose, Palete, Finish, Balance, Util
        ...
        # Set question positions and rating ranges
        ...
        # Create buttons for calculating score and managing results
        ...
        self.save_button.place(x=380, y=760)
        
        self.exit_button = tk.Button(root, text="Exit", command=self.root.quit)
        self.exit_button.place(x=460, y=760)

        # Initialize tasting notes info
        ...
        self.info_dict = {
            ...
            "Musty": "퀴퀴한(묵은내)", "Nutty": "견과류", "Oak": "오크향",
            ...
            "Salty": "짭잘함", "Savory": "여운이 남는", "Sherry": "쉐리향", "Smooth": "부드러움", "Spicy":"매콤한",
            "Sweet": "달콤함", "Tannic": "떫은", "Toasty": "구운 곡물", "Toffee": "토피",
    ...
    def toggle_display(self):
        """Toggle between displaying English and Korean in the info panel."""
        self.display_keys = not self.display_keys
        self.update_info_panel()

    def update_info_panel(self):
        """Update the information panel with selected tasting notes."""
        ...
        # Create a frame to hold the buttons in rows
        button_frame = tk.Frame(self.info_frame)
        button_frame.pack()

        # Create a row for buttons
        for index, item in enumerate(items):
            button_text = str(item)
            button = tk.Button(button_frame, text=button_text, command=lambda item=item: self.toggle_selection(item))
            button.grid(row=index // 3, column=index % 3, padx=2, pady=2, sticky="ew")  # Place button in a grid
    ...
    def toggle_selection(self, item):
        """Toggle selection of a tasting note."""
        if item in self.selected_info:
    ...
    def set_score(self, question_index, score):
        """Set the score for a particular question."""
    ...
    def calculate_total_score(self):
        ...
        self.update_star_label(total_score)
    ...
    def save_to_file(self):
        """Save scores and selected tasting notes to a file."""
